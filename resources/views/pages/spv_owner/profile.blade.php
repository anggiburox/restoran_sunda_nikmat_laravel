            ...
            <div class="card">
                <div class="card-body">
                    <div class="basic-form custom_file_input">
                        @foreach($user as $p)
                        <form action="/spv_owner/profile/editprofile" method="POST" id='form-submit' enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <a href="/spv_owner/dashboard" class="btn btn-secondary"><i class='bi bi-x-circle'></i>&nbsp;
                                Kembali</a>'
                        </form>
                        @endforeach
                    </div>
