            ...
            <div class="card">
                <div class="card-body">
                    <div class="basic-form custom_file_input">
                        @foreach($user as $p)
                        <form action="/admin/profile/editprofile" method="POST" id='form-submit' enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <a href="/admin/dashboard" class="btn btn-secondary"><i class='bi bi-x-circle'></i>&nbsp;
                                Kembali</a>'
                        </form>
                        @endforeach
                    </div>
