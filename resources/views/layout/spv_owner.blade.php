    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/spv_owner/dashboard" class="brand-logo">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/spv_owner/profile" class="dropdown-item">
                                        <i class="icon-user"></i>
        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu">
                    ...
                    <li>
                        <a href="/spv_owner/dashboard" aria-expanded="false">
                            <i class="icon icon-app-store"></i>
                            <span class="nav-text">Dashboard</span></a>
                    </li>
                    <li>
                        <a href="/spv_owner/laporan" aria-expanded="false">
