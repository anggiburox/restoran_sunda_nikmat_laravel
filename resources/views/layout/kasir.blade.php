    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/kasir/dashboard" class="brand-logo">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/kasir/profile" class="dropdown-item">
                                        <i class="icon-user"></i>
        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu">
                    ...
                    <li>
                        <a href="/kasir/dashboard" aria-expanded="false">
                            <i class="icon icon-app-store"></i>
                            <span class="nav-text">Dashboard</span></a>
                    </li>
                    <li>
                        <a href="/kasir/produk" aria-expanded="false">
                            <i class="fa-regular fa-boxes-stacked"></i>
                            <span class="nav-text">Produk</span></a>
                    </li>
                    <li>
                        <a href="/kasir/produk_masuk" aria-expanded="false">
                            <i class="fa-regular fa-box-archive"></i>
                            <span class="nav-text">Produk Masuk</span></a>
                    </li>
                    <li>
                        <a href="/kasir/transaksi" aria-expanded="false">
