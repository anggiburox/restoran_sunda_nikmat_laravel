...
class ProdukControllerAdmin extends Controller
{
    ...
    {   
        ...
        return view('pages/admin/produk/index',['pgw' => $pgw]);
    }

    public function tambah(){
		$kode = ProdukModel::kode();
        return view('pages/admin/produk/tambah', ['kode'=>$kode]);
    }
	...
	return redirect('/admin/produk/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
	{
		...
		return view('pages/admin/produk/edit',['pgw' => $pgw]);
	}
	...
	public function update(Request $request){
		...
		// alihkan halaman ke halaman produk
		return redirect('/admin/produk')->withSuccess('Data berhasil diperbaharui');
	}
	...
	public function hapus($id){
		...
		// alihkan halaman ke halaman produk
		return redirect('/admin/produk')->withDanger('Data berhasil dihapus');
	}
}