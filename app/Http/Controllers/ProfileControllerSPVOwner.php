...
class ProfileControllerSPVOwner extends Controller
{
    /**
     ...
     */
     ...
     {  
         ...
         return view('pages/spv_owner/profile', ['user'=>$user]);
     }
     ...
     public function editprofile(Request $request){
         ...
         return redirect('/spv_owner/profile')->withSuccess('Data berhasil diperbaharui');
     }
