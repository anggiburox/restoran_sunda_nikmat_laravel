...
class LaporanControllerSPVOwner extends Controller
{
    ...
    public function laporan_penjualan_detail(){
        $pgw = TransaksiModel::produkjointransaksi();
        return view('pages/spv_owner/laporan/laporan_penjualan_detail', ['pgw'=>$pgw]);
    }

    public function laporan_pajak_restoran(){
        $pgw = TransaksiModel::produkjointransaksi();
        return view('pages/spv_owner/laporan/laporan_pajak_restoran', ['pgw'=>$pgw]);
    }

    public function laporan_biaya_service(){
        $pgw = TransaksiModel::produkjointransaksi();
        return view('pages/spv_owner/laporan/laporan_biaya_service', ['pgw'=>$pgw]);
    }
}