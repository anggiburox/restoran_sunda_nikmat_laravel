...
class LaporanControllerSPVOwner extends Controller
{
    ...
    public function laporan_penjualan_detail(Request $request)
    {
        ...
        return view('pages/spv_owner/laporan/laporan_penjualan_detail', ['pgw' => $pgw, 'count' => $count, 'start_date' => $start_date, 'end_date' => $end_date]);
        // $pgw = TransaksiModel::produkjointransaksi();
    }
    ...
    public function laporan_pb1_dan_biaya_service(Request $request)
    {
        ...
        return view('pages/spv_owner/laporan/laporan_pb1_dan_biaya_service', ['pgw' => $pgw, 'count' => $count, 'start_date' => $start_date, 'end_date' => $end_date]);
        // $pgw = TransaksiModel::produkjointransaksi();
    }
