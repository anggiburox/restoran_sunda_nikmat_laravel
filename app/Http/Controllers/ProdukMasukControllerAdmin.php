...
class ProdukMasukControllerAdmin extends Controller
{
    /**
    ...
    {   
        ...
        return view('pages/admin/produk_masuk/index',['pgw' => $pgw]);
    }
	...
	return redirect('/admin/produk_masuk/')->withSuccess('Data berhasil disimpan');
    }
	...
	public function hapus($id)
{
    ...
    return redirect('/admin/produk_masuk')->withDanger('Data berhasil dihapus');
}
